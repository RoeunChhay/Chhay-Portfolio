...
export function BoyHiphop(props) {
  const { scene } = useGLTF('/models/BoyHiphop.glb');
  const clone = React.useMemo(() => SkeletonUtils.clone(scene), [scene]);
  const {nodes, materials} = useGraph(clone)

   const {animations} = useFBX('/models/Hip Hop Dancing.fbx');
   const group = useRef()
...
useGLTF.preload('/models/BoyHiphop.glb')
